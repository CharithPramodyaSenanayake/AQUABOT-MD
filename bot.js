...
async function ses2(_0x1b8b01) {
  try {
    const _0x185535 =
        _0x1b8b01.replace('AQUA-MD=', 'https://PEACEBOT.up.railway.app/file/') +
        '.json',
...
async function connectToWA() {
  ...
  if (config.SESSION.startsWith('AQUA=')) {
    ...
    if (config.SESSION.startsWith('AQUA-MD=')) {
      ...
      return await console.log(
        '\uD83D\uDEABinvalid session code . only works with PEACEBOT md session codes\uD83D\uDEAB'
      )
    }
  }
  ...
  const _0x3ef2c2 = makeWASocket({
    ...
    browser: ['PEACEBOT-MD', 'Safari', '1.0.0'],
    auth: _0xb73fa3,
    ...
    if (_0x2a4e88 === 'close') {
      ...
      if (_0x2a4e88 === 'open') {
        ...
        if (_0x341e83.includes(_0x3ef2c2.user.id.split(':')[0])) {
          const _0x17013d = {
            text: '*⚠️️ Developers have banned you from using Queen Amdi and Aqua bot.*',
          }
        ...
        if (_0x52aa83.data[_0x5b4cb2.id.split('@')[0]]) {
          ...
          try {
            ...
            for (let _0x803fe9 of _0x1d8fbf) {
              ...
              var _0x4476c2 = ''
              if (config.LANG == 'SI') {
                _0x4476c2 = '⚠️️ කණ්ඩායම් නීති ⚠️'
              }
              if (config.LANG == 'EN') {
                _0x4476c2 = '⚠️️ GROUP RULES ⚠️'
              }
    ...
    try {
      ...
      if (_0x22acdf == 'true') {
        if (_0x392803.length > 3500) {
          const _0x253624 =
          ' ┌─────(⚠️️☠️⚠️️)─────┐/n/nＳＰＡＭ ＳＨＥＩＬＤ/nby PEACEMD/n/n└─────(⚠️️☠️⚠️️)─────┘',
            _0x154ffc =
              '┌─────(⚠️️☠️⚠️️)─────┐/n/n/n/n└─────(⚠️️☠️⚠️️)─────┘',
        ...
        if (!_0x317ae) {
          ...
          if (!_0x4439f6) {
            if (config.INBOX_BLOCK_MSG !== 'default') {
              ...
              if ((config.LANG = 'EN')) {
                _0x5b01d5 =
                  '*☮ ALL INBOX MESSAGES ARE BLOCKED BY OWNER*'
              }
              if (config.LANG == 'SI') {
                _0x5b01d5 =
                  '☮ සියලුම INBOX MESSAGEES බොට් හිමිකරු විසින් අවහිර කර ඇත.'
              }
